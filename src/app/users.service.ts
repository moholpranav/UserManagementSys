...
export class UsersService {
  ...
  async login(email:string, password:string):Promise<any>{     //for login
  ...
  async register(userData:any, token:string):Promise<any>{  // registration
  ...
  async getAllUsers(token:string):Promise<any>{       //togetall users
  ...
  async getYourProfile(token:string):Promise<any>{   //for profile
  ...
  async getUsersById(userId: string, token:string):Promise<any>{  //byid
  ...
  async deleteUser(userId: string, token:string):Promise<any>{  //fordelete
  ...
  async updateUSer(userId: string, userData: any, token:string):Promise<any>{  //update
